...
export class ServersViewModel {
    ...
    constructor(
        ...
        this.tempFileViewModel = new FileViewModel('Temp Saves', serverFileService.tempSaveFiles, serverIdService.currentServerId);
        this.localFileViewModel = new FileViewModel('Local Saves', serverFileService.localSaveFiles, serverIdService.currentServerId);
        this.globalFileViewModel = new FileViewModel('Global Saves', serverFileService.globalSaveFiles, serverIdService.currentServerId);
